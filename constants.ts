...
export const ASSETS = {
  ...
  CATEGORY: {
    ...
    MALE: 'https://i.ibb.co/MkxwX2kZ/Chat-GPT-Image-2025-12-17-01-01-42-1.png',   // Rec: 2000 x 1000 px (Wide)
    // Girl / Female collection banner
    FEMALE: 'https://i.ibb.co/VWjDCLqN/F9-F82-ABA-2-D08-4259-B455-90-EF48868-A5-D.jpg', // Rec: 2000 x 1000 px (Wide)
  },
            ...
            <h3 class="text-xl font-serif text-mofu-black mb-4">返品・交換・保証について</h3>
             <dl class="space-y-6 text-sm text-stone-600">
              ...
              <div>
                ...
                <dd>当社では出荷前に十分な検品を行っておりますが、万が一、お届けした商品に「不良箇所」や「注文内容との相違」がございましたら、各販売サイトの問い合わせフォーム、或者下述までご連絡ください。<br/><br/>連絡先： info@niijima-soukenn.com<br/>対応期限： 商品到着後7日以内<br/><br/>速やかに良品との交換、または返金対応をさせていただきます。※不良品・誤配送の場合、返品・交換にかかる送料は弊社（または各モール規定）が負担いたします。※使用済み、またはお客様の元でキズ・汚れが生じた商品につきましては、ご対応いたしかねる場合がございます。</dd>
              </div>
            </dl>
          </section>
        </div>
...
export const TRANSLATIONS = {
  ...
  ZH_TW: {
    ...
    philArtisanText: '「神在細節中」。這句話對小衣服來說更為重要。僅數毫米的縫線偏差，都可能傷到他們薄薄的皮膚。僅數公克的重量，都可能遲鈍他們輕盈的步伐。正因如此，我們以日本的「職人精神」挑戰。解讀身體曲線的立體奧妙。觸摸瞬間便能感受的素材選定。在看不見的收邊處花費最多時間的開發。看似簡單的一件衣服，縫入了我們近乎「過度保護」的愛與技術。',
...
const DEFAULT_GALLERY_IMAGES = [
  "https://images.unsplash.com/photo-1599148401005-fe6d75f68c32?q=80&w=800&auto=format&fit=crop", // Detail 1
  "https://images.unsplash.com/photo-1584589167171-541ce45f1eea?q=80&w=800&auto=format&fit=crop", // Detail 2
  "https://images.unsplash.com/photo-1598133869164-6eb75f380f70?q=80&w=800&auto=format&fit=crop", // Detail 3
  "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?q=80&w=800&auto=format&fit=crop"  // Detail 4
];
